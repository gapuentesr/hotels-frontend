...
export default {
  ...
  methods: {
    async fetchHotel() {
      try {
        const response = await axios.get(`${API_BASE_URL}/hotels/${this.$route.params.id}`);
    ...
    async fetchRoomTypes() {
      try {
        const response = await axios.get(`${API_BASE_URL}/hotels/${this.$route.params.id}/room-types`);
